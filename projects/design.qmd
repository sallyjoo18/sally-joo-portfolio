...
<p>Explored different educational subjects to determine the learning outcome our game will be centered around. Our team's final learning outcome was the following: </p>


2. **Refinement & Iteration:**  

<p>Multiple playthroughs led to the development of 3 prototypes for the game. Each prototype expanded on a different aspect of the learning outcome that we could achieve better through manipulating different design elements. </p>
